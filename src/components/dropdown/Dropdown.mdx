...
No need to reinvent the wheel. Use a `<select>` element for the dropdown menu. This element is well-supported by assistive technologies and is familiar to users.
